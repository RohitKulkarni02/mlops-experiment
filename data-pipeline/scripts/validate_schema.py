"""
Data validation: expected audio format (16kHz, mono), duration bounds, emotion labels.
Outputs JSON schema and quality report. Compatible with Great Expectations patterns.
"""
import json
